...
<div class="container">
    ...
    <div class="admin-nav">
        <a href="manage.php" class="btn btn-primary">Gérer les listes</a>
        <a href="import.php" class="btn btn-primary">Importer une liste</a>
        <a href="export.php" class="btn btn-primary">Exporter une liste</a>
    </div>
    ...
    <?php if (empty($lists)): ?>
        <div class="alert alert-info">
            Aucune liste n'a encore été créée. <a href="manage.php">Créer une nouvelle liste</a>.
        </div>
    <?php else: ?>
                    ...
                    <?php foreach ($lists as $list): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="manage.php?delete=<?php echo $list['id']; ?>" class="btn btn-small btn-delete" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette liste ?');">Supprimer</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
